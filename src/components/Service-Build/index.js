...
class ServiceBuild extends Component {
    render() {
       return(
        <div>
            <div className="services-build main-container mt-4 mb-4">
                <h2 className="ff-semi fs-24 mb-4">Строительство бань, домов, капитальных строений</h2>
